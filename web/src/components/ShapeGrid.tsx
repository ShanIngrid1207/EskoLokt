// ShapeGrid — animated canvas grid of shapes (from React Bits), adapted to TS.
// Used as the drifting background of the LoadingTransition. Pointer-reactive:
// shapes fill toward `hoverFillColor` under the cursor and fade out as a trail.
...
export default function ShapeGrid({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      const pushTrail = (col: number, row: number) => {
        if (
